    ...
    const onSubmit = async (data) => {
        try {
            if (action === "Sign Up") {
                ...
                const response = await axios.post('https://journey-mate-backend.onrender.com/api/users/add', data);
                ...
                const response = await axios.post('https://journey-mate-backend.onrender.com/api/users/login', loginData);
